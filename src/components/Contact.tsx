      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-14">
          ...
          <p className="text-slate-600 text-base sm:text-lg">
            Have questions or want to collaborate? Connect with the Kruponam 2026 organizing team.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-6 border border-gold-royal/30 shadow-card-soft space-y-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-serif font-bold text-lg text-slate-900">Campus Address</h3>
              ...
              <div className="flex items-start gap-4 pt-4 border-t border-slate-100">
                ...
                <div>
                  <h3 className="font-serif font-bold text-lg text-slate-900">Phone Hotline</h3>
                  <p className="text-xs text-slate-600 mt-1">
                    +91 80 6570 0000 / +91 98800 12345
                  </p>
                  <p className="text-[11px] text-slate-400">Mon - Sat: 9:00 AM to 5:00 PM</p>
                </div>
              </div>
            ...
            {/* Social Media Links */}
            <div className="bg-white rounded-3xl p-6 border border-gold-royal/30 shadow-card-soft text-center space-y-3">
              ...
              <div className="flex justify-center gap-3 pt-1">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-4 py-2.5 rounded-full bg-cream-soft hover:bg-gold-light/30 border border-gold-royal/30 text-slate-700 text-xs font-bold transition-all flex items-center gap-2"
                >
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl p-6 sm:p-8 border border-gold-royal/40 shadow-card-hover">
            ...
            <p className="text-xs text-slate-500 mb-6">
              Our student council and faculty conveners will reply within 12 hours.
            </p>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <input
                  type="text"
                  placeholder="Subject (e.g., Pookalam Contest / Volunteer / Pass Help)"
